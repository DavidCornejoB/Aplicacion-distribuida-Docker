...
a persistence unit "appdockerPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/distribuidos/appdocker/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "appdocker/pom.xml":
...
artifact ("appdocker.war") is already built. You can build
